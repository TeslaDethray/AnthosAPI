...
class PlantsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('ScientificNames', [
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->add('seasonality', 'valid', ['rule' => 'numeric'])
            ->allowEmpty('seasonality');

        $validator
            ->add('vase_life', 'valid', ['rule' => 'numeric'])
    ...
    {
        $rules->add($rules->existsIn(['scientific_name_id'], 'ScientificNames'));
        return $rules;
    }
}
