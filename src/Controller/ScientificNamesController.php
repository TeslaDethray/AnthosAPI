...
class ScientificNamesController extends AppController {
  ...
  public function view($id = null) {
    $scientificName = $this->ScientificNames->get(
      $id,
      ['contain' => ['Plants']]
    );
  ...
  public function add() {
    ...
    if ($this->request->is('post')) {
      $scientificName = $this->ScientificNames->patchEntity(
        $scientificName,
        $this->request->data
      );
      if ($this->ScientificNames->save($scientificName)) {
        ...
        $this->Flash->error(
          __('The scientific name could not be saved. Please, try again.')
        );
      }
    }
  ...
  public function delete($id = null) {
    ...
    if ($this->ScientificNames->delete($scientificName)) {
      ...
      $this->Flash->error(
        __('The scientific name could not be deleted. Please, try again.')
      );
    }
    $redirection = $this->redirect(['action' => 'index']);
    return $redirection;
